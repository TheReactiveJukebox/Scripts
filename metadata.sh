...
then
    ...
    python ./ExternalDataSource/lastfmcrawler.py ./id3data.csv ./ExternalDataSource/genres.csv
...
then
    ...
    python ./MusicAnalyzing/SongAnalyzer.py bpm ./Music
...
then
    echo "Generating data, this could take a few minutes..."
    python ./MusicAnalyzing/SongAnalyzer.py dynamics ./Music
...
then
    echo "Fetching data, this could take a few minutes..."
    python ./BpmAnalyzer/BpmAnalyzer.py lastfmdata.csv
